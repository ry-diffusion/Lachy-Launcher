...
class ServerInstanceEventCoordinator
{
  ...
  std::vector<mcpe::function<EventResult(ServerInstanceEventListener *)>>
      handlers;
...
class ConnectionDefinition
{
 ...
 public:
  ConnectionDefinition(int port, int portv6, int max)
      : port((short)port), portv6((short)portv6), maxPlayers(max)
  {
  }
};
...
class ServerInstance
{
 public:
  ...
  /// @symbol
  /// _ZN14ServerInstanceC2ER13IMinecraftAppR30ServerInstanceEventCoordinator
  ...
  void initializeServer(
      ...
      ContentTierManager const &, ResourcePackManager &,
