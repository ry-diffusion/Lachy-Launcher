...
class LevelSettings
{
 public:
  ...
  bool xblBroadcastIntent, mpGame, lanBroadcast,
      xblBroadcast;         // 2d, 2e, 2f, 2e
  int xblLanBroadcastMode;  // 34
  bool commandsEnabled;     // 35
  bool texturepacksRequired, lockedBehaviourPack, lockedResourcePack,
      fromLockedTemplate;                // 36, 37, 38, 39
