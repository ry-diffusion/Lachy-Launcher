  ...
  namespace server
  {
    ...
    class service : public service_impl::callback_interface, public rpc_handler
    {
     ...
     public:
      ...
      service(std::string const& path)
          : service(service_impl_factory::create_platform_service())
      {
        impl->bind(path);
      }
      ...
      void handle_message(connection& client,
                          simpleipc::rpc_message const& req) override
      {
