...
bool varint::try_decode_unsigned(const char* in, size_t ins,
                                 unsigned long long& res, size_t* len)
{
...
unsigned long long varint::decode_unsigned(const char* in, size_t ins,
                                           size_t* len)
{
