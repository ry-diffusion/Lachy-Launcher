...
public:
    static bool isAtLeast(int major, int minor, int patch = -1, int revision = -1) {
        return !SharedConstants::MajorVersion || *SharedConstants::MajorVersion > major || (*SharedConstants::MajorVersion == major &&
    ...
    static bool isExactly(int major, int minor, int patch, int revision) {
        return SharedConstants::MajorVersion && *SharedConstants::MajorVersion == major && *SharedConstants::MinorVersion == minor &&
