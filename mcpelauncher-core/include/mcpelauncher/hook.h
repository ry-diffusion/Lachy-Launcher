...
class HookManager
{
 ...
 private:
  ...
  std::unordered_map<LibSymbolPair, std::shared_ptr<HookedSymbol>,
                     LibSymbolPairHash>
      hookedSymbols;
 ...
 public:
  ...
  HookInstance* createHook(void* lib, Elf32_Word symbolIndex, void* replacement,
                           void** orig);

  HookInstance* createHook(void* lib, const char* symbolName, void* replacement,
                           void** orig);
