...
namespace cll
{
  ...
  class EventSerializer
  {
   ...
   private:
    static std::string getEventTimeAsString(
   ...
   public:
    ...
    /**
     * Sets the application id and version, which will be included in the
     * envelope.
     * @param appId application id in the format of 'T:name', eg.
     * 'A:com.package.name' for an Android app
    ...
    /**
     * Sets the OS name and version, which will be included in the envelope. You
     * probably will not need to call it, as the constructor sets it based on
     * the system uname.
    ...
    /**
     * This functions sets an epoch attached with events. You probably will not
     * need to call it, as the constructor sets a random epoch already.
