...
namespace cll
{
  ...
  class UserInfoExtension : public EventSerializer::Extension
  {
   ...
   public:
    ...
    void setLocalId(std::string const& localId)
    {
    ...
    nlohmann::json build(Event const&) override
    {
      return data;
    }
  };
  ...
  class DeviceInfoExtension : public EventSerializer::Extension
  {
   ...
   public:
    ...
    void setDeviceClass(std::string const& deviceClass)
    {
      data["deviceClass"] = deviceClass;
    }
    void clearDeviceClass()
    {
      data.erase("deviceClass");
    }
  ...
  class DefaultExtensions
  {
   ...
   public:
    ...
    UserInfoExtension& getUser()
    {
      return user;
    }
    OsInfoExtension& getOs()
    {
      return os;
    }
    DeviceInfoExtension& getDevice()
    {
      return device;
    }
    AndroidExtension& getAndroid()
    {
      return android;
    }
  };
