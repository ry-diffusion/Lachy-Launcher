...
class jnivm::XBLoginCallback : public jnivm::java::lang::Object
{
 public:
  ...
  void (*auth_flow_callback)(JNIEnv *env, void *, jlong paramLong,
                             jint paramInt, jstring paramString);
...
class com::mojang::minecraftpe::MainActivity : public jnivm::java::lang::Object
{
  ...
  void (*nativeWebRequestCompleted)(JNIEnv *, void *, jint paramInt1,
                                    jlong paramLong, jint paramInt2,
                                    jstring paramString);
 ...
 public:
  ...
  bool isKeyboardMultiline() const
  {
    return currentTextMutliline;
  }
  ...
  static void saveScreenshot(JNIEnv *, jclass, jnivm::java::lang::String *,
                             jint, jint, jnivm::Array<jint> *);
  void postScreenshotToFacebook(JNIEnv *, jnivm::java::lang::String *, jint,
                                jint, jnivm::Array<jint> *);
  ...
  jnivm::java::lang::Object *getSystemService(JNIEnv *,
                                              jnivm::java::lang::String *);
  jnivm::android::view::Window *getWindow(JNIEnv *);
  jint getKeyFromKeyCode(JNIEnv *, jint, jint, jint);
  void updateLocalization(JNIEnv *, jnivm::java::lang::String *,
                          jnivm::java::lang::String *);
  void showKeyboard(JNIEnv *, jnivm::java::lang::String *, jint, jboolean,
                    jboolean, jboolean);
  ...
  void share(JNIEnv *, jnivm::java::lang::String *, jnivm::java::lang::String *,
             jnivm::java::lang::String *);
  ...
  jnivm::com::mojang::minecraftpe::HardwareInformation *getHardwareInfo(
      JNIEnv *);
  ...
  jnivm::java::lang::String *getSecureStorageKey(JNIEnv *,
                                                 jnivm::java::lang::String *);
  void setSecureStorageKey(JNIEnv *, jnivm::java::lang::String *,
                           jnivm::java::lang::String *);
  void trackPurchaseEvent(
      JNIEnv *, jnivm::java::lang::String *, jnivm::java::lang::String *,
      jnivm::java::lang::String *, jnivm::java::lang::String *,
      jnivm::java::lang::String *, jnivm::java::lang::String *,
      jnivm::java::lang::String *, jnivm::java::lang::String *);
  void sendBrazeEvent(JNIEnv *, jnivm::java::lang::String *);
  void sendBrazeEventWithProperty(JNIEnv *, jnivm::java::lang::String *,
                                  jnivm::java::lang::String *, jint);
  void sendBrazeEventWithStringProperty(JNIEnv *, jnivm::java::lang::String *,
                                        jnivm::java::lang::String *,
                                        jnivm::java::lang::String *);
  ...
  void webRequest(JNIEnv *env, jint paramInt, jlong paramLong,
                  jnivm::java::lang::String *paramString1,
                  jnivm::java::lang::String *paramString2,
                  jnivm::java::lang::String *paramString3,
                  jnivm::java::lang::String *paramString4)
  {
    // std::thread([=]() {
    //     std::this_thread::sleep_for(std::chrono::milliseconds(5000));
    //     nativeWebRequestCompleted(env, clazz, paramInt, paramLong, 2,
    //     env->NewStringUTF(""));
    // }).detach();
  }
};
class com::mojang::minecraftpe::HardwareInformation :
    public jnivm::java::lang::Object
{
 public:
...
{
 public:
  static jnivm::com::mojang::minecraftpe::store::Store *createGooglePlayStore(
      JNIEnv *, jclass, jnivm::java::lang::String *,
      jnivm::com::mojang::minecraftpe::store::StoreListener *);
  static jnivm::com::mojang::minecraftpe::store::Store *createAmazonAppStore(
      JNIEnv *, jclass, jnivm::com::mojang::minecraftpe::store::StoreListener *,
      jboolean);
};
...
class com::mojang::minecraftpe::store::Store : public jnivm::java::lang::Object
{
 public:
  ...
  getExtraLicenseData(JNIEnv *);
  jboolean receivedLicenseResponse(JNIEnv *);
  void queryProducts(JNIEnv *, jnivm::Array<jnivm::java::lang::String *> *);
  void purchase(JNIEnv *, jnivm::java::lang::String *, jboolean,
                jnivm::java::lang::String *);
  void acknowledgePurchase(JNIEnv *, jnivm::java::lang::String *,
                           jnivm::java::lang::String *);
...
class com::mojang::android::net::HTTPRequest : public jnivm::java::lang::Object
{
 public:
  ...
  jnivm::com::mojang::android::net::HTTPResponse *send(
      JNIEnv *, jnivm::java::lang::String *);
  void abort(JNIEnv *);
};
...
{
 public:
  static jnivm::java::lang::String *GetLocalStoragePath(
      JNIEnv *, jclass, jnivm::android::content::Context *);
  static jnivm::java::lang::String *ReadConfigFile(
      JNIEnv *, jclass, jnivm::android::content::Context *);
  static jnivm::java::lang::String *getSystemProxy(JNIEnv *, jclass);
  static void InitCLL(JNIEnv *, jclass, jnivm::android::content::Context *,
                      jnivm::java::lang::String *);
  static void LogTelemetrySignIn(JNIEnv *, jclass, jnivm::java::lang::String *,
                                 jnivm::java::lang::String *);
  static void InvokeMSA(JNIEnv *, jclass, jnivm::android::content::Context *,
                        jint, jboolean, jnivm::java::lang::String *);
  static void InvokeAuthFlow(JNIEnv *, jclass, jlong,
                             jnivm::android::app::Activity *, jboolean,
                             jnivm::java::lang::String *);
  static jnivm::java::lang::String *getLocale(JNIEnv *, jclass);
  static void RegisterWithGNS(JNIEnv *, jclass,
                              jnivm::android::content::Context *);
  static void LogCLL(JNIEnv *, jclass, jnivm::java::lang::String *,
                     jnivm::java::lang::String *, jnivm::java::lang::String *);
};
...
{
 public:
  static void ShowFriendFinder(JNIEnv *, jclass,
                               jnivm::android::app::Activity *,
                               jnivm::java::lang::String *,
                               jnivm::java::lang::String *);
  static void ShowUserSettings(JNIEnv *, jclass,
                               jnivm::android::content::Context *);
  static void ShowUserProfile(JNIEnv *, jclass,
                              jnivm::android::content::Context *,
                              jnivm::java::lang::String *);
};
    ...
    public jnivm::java::lang::Object
{
 public:
  ...
  jboolean hideSoftInputFromWindow(JNIEnv *, jnivm::android::os::IBinder *,
                                   jint);
};
