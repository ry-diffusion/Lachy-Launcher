...
{
  static SLInterfaceID_ SL_IID_ENGINE{ .time_low = 0,
                                       .time_mid = 0,
                                       .time_hi_and_version = 0,
                                       .clock_seq = 0,
                                       .node = { 1, 2, 3, 4, 5, 6 } };
  static SLInterfaceID_ SL_IID_BUFFERQUEUE{ .time_low = 0,
                                            .time_mid = 0,
                                            .time_hi_and_version = 0,
                                            .clock_seq = 0,
                                            .node = { 2, 3, 4, 5, 6, 7 } };
  static SLInterfaceID_ SL_IID_VOLUME{ .time_low = 0,
                                       .time_mid = 0,
                                       .time_hi_and_version = 0,
                                       .clock_seq = 0,
                                       .node = { 1, 2, 3, 4, 5, 8 } };
  static SLInterfaceID_ SL_IID_PLAY{ .time_low = 0,
                                     .time_mid = 0,
                                     .time_hi_and_version = 0,
                                     .clock_seq = 0,
                                     .node = { 1, 2, 3, 4, 5, 9 } };
  ...
  hybris_hook(
      "slCreateEngine",
      (void *)+[](SLObjectItf *pEngine, SLuint32 numOptions,
                  ...
                  const SLboolean *pInterfaceRequired) -> SLresult
      {
        ...
        *pEngine = new SLObjectItf_ *(new SLObjectItf_(
            { .Realize = [](SLObjectItf self, SLboolean async) -> SLresult
              ...
              .GetState = [](SLObjectItf self, SLuint32 *pState) -> SLresult
              {
                return 0;
              },
              .GetInterface = [](SLObjectItf self, const SLInterfaceID iid,
                                 void *pInterface) -> SLresult
              {
                static SLEngineItf_ engine = {
                  .CreateLEDDevice =
                      [](SLEngineItf self, SLObjectItf *pDevice,
                  ...
                  .CreateAudioPlayer =
                      [](SLEngineItf self, SLObjectItf *pPlayer,
                         ...
                         const SLboolean *pInterfaceRequired) -> SLresult
                  {
                    *pPlayer = new SLObjectItf_ *(new SLObjectItf_(
                        { .Realize = [](SLObjectItf self,
                                        SLboolean async) -> SLresult
                          {
                            return 0;
                          },
                          .Resume = [](SLObjectItf self,
                                       SLboolean async) -> SLresult
                          {
                            return 0;
                          },
                                             ...
                                             void *pInterface) -> SLresult
                          {
                            static SLEngineItf_ engine = {
                              ...
                              .CreateMidiPlayer =
                                  [](SLEngineItf self, SLObjectItf *pPlayer,
                                     ...
                                     SLDataSink *pVibra, SLDataSink *pLEDArray,
                                     SLuint32 numInterfaces,
                                     const SLInterfaceID *pInterfaceIds,
                                     const SLboolean *pInterfaceRequired)
                                  -> SLresult
                              ...
                              .CreateListener =
                                  [](SLEngineItf self, SLObjectItf *pListener,
                                     SLuint32 numInterfaces,
                                     const SLInterfaceID *pInterfaceIds,
                                     const SLboolean *pInterfaceRequired)
                                  -> SLresult
                              ...
                              .Create3DGroup =
                                  [](SLEngineItf self, SLObjectItf *pGroup,
                                     SLuint32 numInterfaces,
                                     const SLInterfaceID *pInterfaceIds,
                                     const SLboolean *pInterfaceRequired)
                                  -> SLresult
                              ...
                              .CreateOutputMix =
                                  [](SLEngineItf self, SLObjectItf *pMix,
                                     SLuint32 numInterfaces,
                                     const SLInterfaceID *pInterfaceIds,
                                     const SLboolean *pInterfaceRequired)
                                  -> SLresult
                              ...
                              .CreateExtensionObject =
                                  [](SLEngineItf self, SLObjectItf *pObject,
                              ...
                              .QueryNumSupportedInterfaces =
                                  [](SLEngineItf self, SLuint32 objectID,
                              ...
                              .QuerySupportedExtension =
                                  [](SLEngineItf self, SLuint32 index,
                            ...
                            *((SLEngineItf_ ***)pInterface) =
                                new SLEngineItf_ *(&engine);
                            return 0;
                          },
                          ...
                          .SetPriority = [](SLObjectItf self, SLint32 priority,
                          ...
                          .SetLossOfControlInterfaces =
                              [](SLObjectItf self, SLint16 numInterfaces,
                  ...
                  .CreateMetadataExtractor =
                      [](SLEngineItf self, SLObjectItf *pMetadataExtractor,
                  ...
                  .QuerySupportedInterfaces =
                      [](SLEngineItf self, SLuint32 objectID, SLuint32 index,
                         SLInterfaceID *pInterfaceId) -> SLresult
                  {
                    return 0;
                  },
                  .QueryNumSupportedExtensions =
                      [](SLEngineItf self, SLuint32 *pNumExtensions) -> SLresult
                  {
                    return 0;
                  },
                  .QuerySupportedExtension =
              ...
              .GetPriority = [](SLObjectItf self, SLint32 *pPriority,
                                SLboolean *pPreemptable) -> SLresult
              {
                return 0;
              },
